...
const Experience = () => {
  ...
  return (
    <section id="experience" className="section-padding bg-gradient-to-br from-white via-slate-50 to-blue-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
                    ...
                    <div className="space-y-6">
                      <div className="flex items-start gap-4">
                        ...
                        <motion.div
                          ...
                          className="p-2 rounded-2xl bg-white dark:bg-slate-800 shadow-lg border border-slate-200 dark:border-slate-700"
                        >
                          <div className="w-14 h-14 bg-gradient-to-br from-slate-100 to-slate-200 dark:from-slate-700 dark:to-slate-800 rounded-xl flex items-center justify-center overflow-hidden">
                            <Image
                              src={exp.companyLogo}
                        ...
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-3">
                            <span className="px-3 py-1 bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 text-sm rounded-full font-medium border">
                              {exp.type}
                            </span>
                          </div>
                      ...
                      {/* Technologies */}
                      <div>
                        <h5 className="text-sm font-bold text-slate-800 dark:text-slate-200 mb-4 uppercase tracking-wide">
                          Technologies Used
                        </h5>
                        <div className="flex flex-wrap gap-3">
                          {exp.technologies.map((tech) => (
                            <motion.div
                              ...
                              className="flex items-center space-x-2 px-3 py-2 bg-white dark:bg-slate-800 text-slate-800 dark:text-slate-200 text-sm font-medium rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm hover:shadow-md transition-all duration-300"
                            >
                              <Image
                                src={tech.logo}
                                alt={tech.name}
                      ...
                      <div className="space-y-4">
                        {exp.achievements.map((achievement, idx) => (
                          <motion.div
                            ...
                            className="flex items-start gap-4 p-5 rounded-xl bg-slate-50 dark:bg-slate-800/70 border border-slate-200 dark:border-slate-700 hover:bg-slate-100 dark:hover:bg-slate-800 transition-all duration-300 group/item"
                          >
                            <div className="flex-shrink-0 mt-1">
                              <div className="w-6 h-6 rounded-full bg-green-100 dark:bg-green-900/30 flex items-center justify-center border border-green-200 dark:border-green-800">
                                <ChevronRight size={12} className="text-green-600 dark:text-green-400 group-hover/item:translate-x-0.5 transition-transform" />
                              </div>
                            </div>
                ...
                >
                  ...
                  <div className="flex flex-wrap gap-2">
                    {leadership.technologies.map((tech) => (
                      <div
                        key={tech.name}
                        className="flex items-center space-x-2 px-3 py-1 bg-slate-100 dark:bg-slate-700 text-slate-700 dark:text-slate-300 text-xs rounded-full border font-medium"
                      >
                        <Image
                          src={tech.logo}
                          alt={tech.name}
